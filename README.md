The aim of this challenge is to pull data from the (Guradian Public API)[https://open-platform.theguardian.com] to return all articles related to both "AI" and "analytics" .
